...
class DataCourseCard extends StatelessWidget {
  final DataCourse datacourse;
  DataCourseCard(this.datacourse);
  ...
  Widget build(BuildContext context) {
    final courseImage = new Container(
      ...
      child: new Image(
        image: new AssetImage(datacourse.image),
        height: 60.0,
        width: 107.0,
      ),
    );
    ...
    final courseContent = new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          new Text(datacourse.topics, style: subHeaderTextStyle),
        ],
      ),
    );
