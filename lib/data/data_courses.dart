...
List<DataCourse> datacourses = [
  const DataCourse(
      ...
      topics: "Storytelling with Data, Creating Effective Reports, and Hypothesis Testing",
      duration: "Weeks 1-5",
  ...
  const DataCourse(
      ...
      topics: "Linear Algebra, Linear Regression, Advanced Regression, and Model Validation",
      duration: "Weeks 6-10",
      image: "assets/images/data.png",
      ),
  const DataCourse(
  ...
  const DataCourse(
      ...
      topics: "Unsupervised Learning, Natural Language Processing, and Neural Networks",
