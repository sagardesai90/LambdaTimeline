...
class FullstackwebCourseCard extends StatelessWidget {
  final FullstackwebCourse fullstackwebcourse;
  FullstackwebCourseCard(this.fullstackwebcourse);
  ...
  Widget build(BuildContext context) {
    final courseImage = new Container(
      ...
      child: new Image(
        image: new AssetImage(fullstackwebcourse.image),
        height: 60.0,
        width: 107.0,
      ),
    );
    ...
    final courseContent = new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          new Text(
            fullstackwebcourse.duration,
            style: regularTextStyle,
          ),
          new Container(height: 4.0),
          new Text(
            fullstackwebcourse.name,
          ...
          new Text(fullstackwebcourse.topics, style: subHeaderTextStyle),
        ],
      ),
    );
