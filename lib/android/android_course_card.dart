...
class AndroidCourseCard extends StatelessWidget {
  final AndroidCourse androidcourse;
  AndroidCourseCard(this.androidcourse);
  ...
  Widget build(BuildContext context) {
    final courseImage = new Container(
      ...
      child: new Image(
        image: new AssetImage(androidcourse.image),
        height: 60.0,
        width: 107.0,
      ),
    );
    ...
    final courseContent = new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          new Text(androidcourse.topics, style: subHeaderTextStyle),
        ],
      ),
    );
